...
// TODO: CARGAR LAS PREGUNTAS DESDE UN ARCHIVO EXCEL, 100 PREGUNTAS RELACIONADAS CON CONCEPTOS DE M6
//importar dependencia xlsx
// const xlsx = require('xlsx');

//cargar archivo xlsx en memoria
const file = xlsx.readFile('M6-jocTaulerExcel.xlsx');

//parsear xlsx a JSON
let preguntas2 = {};
preguntas = xlsx.utils.sheet_to_json(file.Sheets['Hoja 1']);
